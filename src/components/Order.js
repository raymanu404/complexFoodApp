  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.text_order}>Discount comanda aplicata: {props.discount} % Reducere</Text>
      </View>
      <View style={[styles.orderContainer, { backgroundColor: getStatusColor() }]}>
        <ImageBackground style={styles.order_info} source={backgroundImageOrder} resizeMode="cover">
        ...
        <TouchableOpacity onPress={() => props.goToOrderItems(props.orderId, props.totalPrice)} activeOpacity={0.8}>
