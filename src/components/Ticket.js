      ...
      <View style={styles.ticket}>
        ...
        <View style={styles.ticket_inner}>
          <View style={styles.ticket_info}>
            <Text style={[styles.text_ticket, { color: colors.white }]}>{props.cupoane}</Text>
            <Text style={[styles.text_ticket, { color: colors.white }]}>Reducere {props.reducere}</Text>
          </View>
          <View style={styles.ticket_price}>
            <Text style={[styles.text_ticket, { color: colors.backgroundButtonActive }]}>PRET</Text>
            <Text style={[styles.text_ticket, { color: colors.backgroundButtonActive }]}>{props.pret} RON</Text>
          </View>
        </View>
        <Text style={styles.text_reducere}>*Se scade din suma totala 10 ron + {props.reducere}%*</Text>
