...
function CouponsList({ navigation, route }) {
  ...
  const applyCouponForBuyer = (code, typeOfCoupon) => {
    try {
      const filtered = coupons.filter(function (value, index) {
        ...
        <>
          ...
          <View style={styles.filterContainer}>
            <Icon
              ...
              size={30}
            />
            <TouchableOpacity style={styles.filterItem} onPress={() => sortCouponsByType()} activeOpacity={0.5}>
              <Icon name={'list-number'} type={'foundation'} color={colors.backgroundBottomTabInactive} size={30} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.filterItem} onPress={() => showOnlyTypeOneCoupons()} activeOpacity={0.5}>
              <Icon
            ...
            <TouchableOpacity style={styles.filterItem} onPress={() => showOnlyTypeTwoCoupons()} activeOpacity={0.5}>
              <Icon
            ...
            <TouchableOpacity style={styles.filterItem} onPress={() => showOnlyTypeThreeCoupons()} activeOpacity={0.5}>
              <Icon
            ...
            <Text style={styles.textFilter}>Total cupoane: {filterType.numberCoupons}</Text>
          </View>
          {/* -------------------- LIST OF COUPONS  ------------------------ */}
