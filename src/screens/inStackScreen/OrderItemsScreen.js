  ...
  return (
    <View style={styles.itemsContainer}>
      ...
      <View style={styles.menu_container}>
        {orderItems.length !== 0 ? (
          <>
            <FlatList data={orderItems} keyExtractor={(item) => item.orderItemId} renderItem={renderMenuItem} />

            <View style={styles.button}>
              <Text style={styles.buttonText}>
                Total comanda: <Text style={styles.buttonTextPrice}>{totalPrice} RON</Text>
              </Text>
            </View>
          </>
        ) : (
