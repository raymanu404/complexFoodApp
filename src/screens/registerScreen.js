  ...
  const onFocusPassword = (val, passowrdType) => {
    switch (passowrdType) {
      case 'password':
        ...
        if (String(val).length < MIN_PASSWORD_LENGTH || String(val).length > MAX_PASSWORD_LENGTH) {
          setInvalidInput({
            ...invalidInput,
            passwordError: true,
      ...
      <View style={styles.header}>
        ...
        >
          <View style={styles.displayColumn}>
            {/* ------------------------------------- PRENUME -------------------------------------- */}
            <View style={onFocusInput.firstNameOnFocus ? styles.textInputContainerOnFocus : styles.textInputContainer}>
              <Icon
                name={'user'}
                type="ant-design"
              ...
              <TextInput
                ...
                style={[
                  !onFocusInput.firstNameOnFocus ? styles.textInput : styles.textInputFocusOn,
                  { fontWeight: '500' },
                ]}
                onSubmitEditing={() => lastNameRef.current.focus()}
                onFocus={() => setOnFocusInput({ ...onFocusInput, firstNameOnFocus: true })}
                onBlur={() =>
                  setOnFocusInput({
                    ...onFocusInput,
                    firstNameOnFocus: false,
            ...
            <Text style={styles.textErrorInput}>{invalidInput.firstNameError ? 'Ex:Ion' : ''}</Text>
          </View>
          {/* ------------------------------------- NUME -------------------------------------- */}
          <View style={styles.displayColumn}>
            <View style={onFocusInput.lastNameOnFocus ? styles.textInputContainerOnFocus : styles.textInputContainer}>
              <Icon
                name={'user'}
                type="feather"
                color={colors.backgroundButtonActive}
              ...
              <TextInput
                ...
                style={[
                  !onFocusInput.lastNameOnFocus ? styles.textInput : styles.textInputFocusOn,
                  { fontWeight: '500' },
                ]}
                returnKeyType={'next'}
                onSubmitEditing={() => phoneRef.current.focus()}
                onFocus={() => setOnFocusInput({ ...onFocusInput, lastNameOnFocus: true })}
                onBlur={() => setOnFocusInput({ ...onFocusInput, lastNameOnFocus: false })}
                autoCapitalize="none"
                placeholder="Nume"
                placeholderTextColor={colors.backgroundButtonActive}
              />
            </View>
            <Text style={styles.textErrorInput}>{invalidInput.lastNameError ? 'Ex:Popescu' : ''}</Text>
          </View>

          {/* ------------------------------------- TELEFON -------------------------------------- */}
          <View style={styles.displayColumn}>
            <View style={onFocusInput.phoneOnFocus ? styles.textInputContainerOnFocus : styles.textInputContainer}>
              <Icon
                name={'phone'}
                type="ant-design"
                color={colors.backgroundButtonActive}
              ...
              <TextInput
                ...
                style={[!onFocusInput.phoneOnFocus ? styles.textInput : styles.textInputFocusOn, { fontWeight: '500' }]}
                onFocus={() => setOnFocusInput({ ...onFocusInput, phoneOnFocus: true })}
                onBlur={() => setOnFocusInput({ ...onFocusInput, phoneOnFocus: false })}
                autoCapitalize="none"
                placeholder="Telefon"
                placeholderTextColor={colors.backgroundButtonActive}
              />
            </View>
            <Text style={styles.textErrorInput}>{invalidInput.phoneError ? '0721 345 211' : ''}</Text>
          </View>

          {/* ----------------------------------- GENDER ------------------------------ */}

          <View style={styles.genderContainerParent}>
            <RadioButton.Group onValueChange={(newValue) => genderRadioHandler(newValue)} value={userInfo.gender}>
            ...
            <Text style={styles.textErrorInput}>{invalidInput.genderError ? 'Selectati unul din optiuni' : ''}</Text>
          </View>

          {/* ---------------------------------- EMAIL ------------------------------- */}
          <View style={styles.displayColumn}>
            <View style={onFocusInput.emailOnFocus ? styles.textInputContainerOnFocus : styles.textInputContainer}>
              <Icon
                name={'mail'}
                type="ant-design"
                color={colors.backgroundButtonActive}
              ...
              <TextInput
                ...
                style={[!onFocusInput.emailOnFocus ? styles.textInput : styles.textInputFocusOn, { fontWeight: '500' }]}
            ...
            <Text style={styles.textErrorInput}>{invalidInput.emailError ? 'test@test.com' : ''}</Text>
          </View>
          {/* ------------------------------------- PAROLA -------------------------------------- */}
          <View style={styles.displayColumn}>
            <View style={onFocusInput.passwordOnFocus ? styles.textInputContainerOnFocus : styles.textInputContainer}>
              <Icon
                name={'lock'}
                type="feather"
                color={colors.backgroundButtonActive}
              ...
              <TextInput
                ...
                style={[
                  !onFocusInput.passwordOnFocus ? styles.textInput : styles.textInputFocusOn,
                  { fontWeight: '500' },
                ]}
                onFocus={() => setOnFocusInput({ ...onFocusInput, passwordOnFocus: true })}
                onBlur={() => setOnFocusInput({ ...onFocusInput, passwordOnFocus: false })}
                autoCapitalize="none"
                placeholder="Parola"
          ...
          <View style={styles.displayColumn}>
            <View
              style={onFocusInput.re_passwordOnFocus ? styles.textInputContainerOnFocus : styles.textInputContainer}
            >
              <Icon
                name={'unlock'}
                type="feather"
              ...
              <TextInput
                ...
                style={[
                  !onFocusInput.re_passwordOnFocus ? styles.textInput : styles.textInputFocusOn,
                  { fontWeight: '500' },
                ]}
                onFocus={() =>
                  setOnFocusInput({
          ...
          <View>
            <Text style={[styles.textErrorInput, { fontSize: 15, color: colors.recycleBin, textAlign: 'center' }]}>
              {invalidInput.emptyFiledsError}
            </Text>
          </View>
          <View style={styles.registerSection}>
            <TouchableHighlight underlayColor={colors.backgroundApp} onPress={() => registerHandler()}>
