          ...
          [
            ...
            },
            {
              ...
              onPress: async () => {
                ...
                const response = await api_axios.post(`/coupons/buy_coupons/${buyerID}`, data, headers)
    ...
    >
      <View style={styles.container}>
        <View style={styles.balance_container}>
          <Text style={styles.text_balance}>Sold disponibil : {Number(userInfo.balance).toFixed(2)} RON</Text>
        </View>
        <ScrollView style={{ marginBottom: 20 }}>
          {/* TICKET 10 RON  */}
          <Ticket reducere={10} pret={10} cupoane={'1 Cupon'} payCoupon={() => paymentHandler(1, 1)} type={1} />
          {/* TICKET 30 RON  */}
          <Ticket reducere={20} pret={30} cupoane={'3 Cupoane'} payCoupon={() => paymentHandler(3, 2)} type={2} />
          {/* TICKET 50 RON  */}
          <Ticket reducere={30} pret={50} cupoane={'5 Cupoane'} payCoupon={() => paymentHandler(5, 3)} type={3} />
        </ScrollView>
        <>
