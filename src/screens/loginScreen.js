      ...
      try {
        ...
        if (response.status === 200) {
          ...
          if (confirmed) {
            ...
            Alert.alert('Cont neconfirmat', 'Contul dumneavoastra nu este confirmat! Doriti sa va confirmati contul?', [
              {
                text: 'NU',
                style: 'cancel',
              },
      ...
      <View style={styles.header}>
        ...
        <Animatable.View style={styles.footer} animation={'fadeInUpBig'}>
          ...
          <View style={{ flexDirection: 'column', marginVertical: 10 }}>
            <View style={onFocusInput.emailFocus ? styles.textInputContainerOnFocus : styles.textInputContainer}>
              <Icon
                name={'mail'}
                type="ant-design"
              ...
              <TextInput
                ...
                style={[!onFocusInput.emailFocus ? styles.textInput : styles.textInputFocusOn, { fontWeight: '500' }]}
                onFocus={() => setOnFocusInput({ ...onFocusInput, emailFocus: true })}
                onBlur={() => setOnFocusInput({ ...onFocusInput, emailFocus: false })}
                autoCapitalize="none"
                placeholder="Email"
          ...
          {/* -------------------------PASSWORD  ---------------------- */}
          <View style={{ flexDirection: 'column', marginVertical: 10 }}>
            <View style={onFocusInput.passwordFocus ? styles.textInputContainerOnFocus : styles.textInputContainer}>
              <Icon
                name={'lock'}
                type="feather"
                color={colors.backgroundButtonActive}
              ...
              <TextInput
                ...
                style={[
                  !onFocusInput.passwordFocus ? styles.textInput : styles.textInputFocusOn,
                  { width: width - 100, fontWeight: '500' },
                ]}
                onBlur={() => setOnFocusInput({ ...onFocusInput, passwordFocus: false })}
                onFocus={() => setOnFocusInput({ ...onFocusInput, passwordFocus: true })}
                autoCapitalize="none"
                placeholder="Parola"
              ...
              <TouchableOpacity style={[styles.icon, { paddingRight: 10 }]} onPress={() => changePasswordVisibility()}>
                <Icon name={passwordVisible ? 'eye-off' : 'eye'} type="feather" color={colors.backgroundButtonActive} />
              </TouchableOpacity>
            </View>
          ...
          <TouchableOpacity onPress={() => forgotPasswordHandler()} style={{ marginTop: -18 }}>
            <Text style={styles.text}>Ai uitat parola?</Text>
          </TouchableOpacity>
          <View style={styles.loginButtonsContainer}>
            <TouchableHighlight onPress={() => loginHandler()} underlayColor={colors.white}>
